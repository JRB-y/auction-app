...
/* harmony import */ var _UnliveAuction__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./UnliveAuction */ "./resources/js/components/Auction/UnliveAuction/index.vue");
/* harmony import */ var _LiveAuction__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./LiveAuction */ "./resources/js/components/Auction/LiveAuction/index.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    UnliveAuction: _UnliveAuction__WEBPACK_IMPORTED_MODULE_2__["default"],
    LiveAuction: _LiveAuction__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  data: function data() {
    return {
      auction: []
  ...
  methods: {
    getAuction: function getAuction() {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function getAuction$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/auction/".concat(this.$route.params.id)).then(function (data) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _BetHistory__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./BetHistory */ "./resources/js/components/Auction/LiveAuction/BetHistory.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ["auction"],
  components: {
    BetHistory: _BetHistory__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  data: function data() {
    return {
  ...
  return _c(
    ...
    [
      !_vm.auction.is_live
        ...
        : _c("live-auction", { attrs: { auction: _vm.auction } })
    ],
    1
  )
}
                          ...
                          _c(
                            ...
                            [
                              _c("v-list-item-action-text", {
                                domProps: { textContent: _vm._s(item.action) }
                              }),
                              _vm._v(" "),
                              !active
                                ? _c(
